  ...
  const capacitaciones = [
    {
      ...
      descripcion: 'Crédito Fiscal, Documentos Soporte y Buenas Prácticas Contables.',
      duracion: '6 horas',
    },
    {
      mes: 'Julio',
    ...
    },
    {
      ...
      descripcion: 'En el Sector Cementero: Cumplimiento, Riesgos y Optimización Tributaria.',
      duracion: '6 horas',
    },
    {
      mes: 'Octubre',
    ...
    <div style={{ backgroundColor: '#f4f6fc', paddingBottom: '6rem' }}>
      ...
      >
        ...
        <p className="lead fs-4" style={{ maxWidth: '750px', margin: 'auto' }}>
          Actualización fiscal adaptada al contexto hondureño. Conocé nuestros temas mensuales In Company 2025.
        </p>
      </div>
          ...
          <Accordion activeKey={activeKey} flush>
            {capacitaciones.map((item, index) => (
              ...
              >
                ...
                <Accordion.Body>
                  {item.descripcion && <p className="mb-2">{item.descripcion}</p>}
                  <p className="mb-3"><strong>Duración:</strong> {item.duracion}</p>
